...
API_ID = int(environ.get('API_ID', '10001245'))
API_HASH = environ.get('API_HASH', '9b5c685aa1e31f2f273d038572d62eae')
BOT_TOKEN = environ.get('BOT_TOKEN', "7206066555:AAF11YGPRWX89EGyU8WtLsHhHQwzGsY-Ybw")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1151183031').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '1001635897749'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '1001120098272').split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://kurrodukakinada:G93HUVJU2Us6nQKi@cluster0.unjhsxl.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
